...
public class SkystoneDetectorEx extends OpenCvPipeline {
    ...
    volatile com.arcrobotics.ftclib.vision.SkystoneDetector.SkystonePosition position;


    ArrayList<Rect> blocks;

    public SkystoneDetectorEx(Telemetry tl) {
        this.tl = tl;
        defaultValues = true;
        blocks = null;
        means = new ArrayList();
    ...
    public SkystoneDetectorEx() {
        this(null);
    }

    public SkystoneDetectorEx(double firstSkystonePositionPercentage, double percentSpacing, double stoneWidth, double stoneHeight, Telemetry tl){
        defaultValues = false;
    ...
    public SkystoneDetectorEx(double firstSkystonePositionPercentage, double percentSpacing, double stoneWidth, double stoneHeight){
        this(firstSkystonePositionPercentage, percentSpacing, stoneWidth, stoneHeight, null);

    }

    public SkystoneDetectorEx(double ySpacing, double firstSkystonePositionPercentage, double percentSpacing, double stoneWidth, double stoneHeight){
        defaultValues = false;
    ...
    public Mat processFrame(Mat input) {
        ...
        try {
            ...
            switch (biggestIndex) {
                case 0:
                    position = com.arcrobotics.ftclib.vision.SkystoneDetector.SkystonePosition.LEFT_STONE;
                    ...
                    break;
                case 1:
                    position = com.arcrobotics.ftclib.vision.SkystoneDetector.SkystonePosition.CENTER_STONE;
                ...
                case 2:
                    ...
                    position = com.arcrobotics.ftclib.vision.SkystoneDetector.SkystonePosition.RIGHT_STONE;
                    break;
                default:
                    position = com.arcrobotics.ftclib.vision.SkystoneDetector.SkystonePosition.RIGHT_STONE;
                    Imgproc.rectangle(input, blocks.get(0), new Scalar(255, 0, 0), 30);
    ...
    public com.arcrobotics.ftclib.vision.SkystoneDetector.SkystonePosition getSkystonePosition() {
        return position;
    }
    ...
    private void setValues(double width, double height) {
        if (blocks == null) {
            ...
            blocks.add(new Rect(new Point(firstStonePosition - (stoneWidth / 2), ySpacing * height - (stoneHeight / 2)),
                    new Point(firstStonePosition + (stoneWidth / 2), ySpacing * height + (stoneHeight / 2))));
            blocks.add(new Rect(new Point(secondStonePosition - (stoneWidth / 2), ySpacing * height - (stoneHeight / 2)),
                    new Point(secondStonePosition + (stoneWidth / 2), ySpacing * height + (stoneHeight / 2))));
            blocks.add(new Rect(new Point(thirdStonePosition - (stoneWidth / 2), ySpacing * height - (stoneHeight / 2)),
                    new Point(thirdStonePosition + (stoneWidth / 2), ySpacing * height + (stoneHeight / 2))));
        }
    }
}
