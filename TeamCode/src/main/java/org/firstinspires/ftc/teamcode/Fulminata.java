...
public class Fulminata extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            if (this.gamepad2.y) {
                ...
                if (goalLiftHeight == 1) {
                    ...
                    linearLift.setTargetPosition(3360);
                    linearLift.setPower(.25);
                    linearLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            ...
            telemetry.addData("Rotations of lift:",linearLift.getCurrentPosition());

            telemetry.addData("goalLiftHeight", goalLiftHeight);
