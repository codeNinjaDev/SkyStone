...
public class SineWaveOpMode extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            packet.put("x", AMPLITUDE * Math.sin(
            ...
            if (dashboard != null) {
                telemetry.addData("dashboard", "true");
                telemetry.addData("dashInterval",dashboard.getTelemetryTransmissionInterval());


            } else {
                telemetry.addData("dashboard", "false");
